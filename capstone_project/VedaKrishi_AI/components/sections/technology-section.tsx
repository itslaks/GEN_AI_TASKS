      ...
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            style={{
              color: isRevealed ? "var(--foreground)" : "var(--border)",
            }}
          >
...
export function TechnologySection() {
  ...
  const descriptionText = "VedaKrishi combines traditional farming wisdom with modern AI technology. Our system draws from centuries of agricultural knowledge documented in crop manuals, government research papers, and expert databases to provide you with accurate, region-specific guidance for every farming decision you make.";
  ...
  return (
    <section ref={sectionRef} id="benefits" className="relative bg-primary">
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="/images/weather-farming.jpg"
                alt="Farmer looking at sky with crops in foreground"
                fill
                className="object-cover"
              />
              ...
              >
                <h2 className="max-w-3xl font-semibold leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Ancient", "Wisdom,", "Modern", "AI."].map((word, index) => {
                    // Each word fades out sequentially based on scrollProgress
                    const wordFadeStart = index * 0.05; // Staggered fade
